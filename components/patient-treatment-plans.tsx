...
export function PatientTreatmentPlans({
  ...
  const treatmentPlan = useMemo((): TreatmentPlan | null => {
    ...
    const condition =
      selectedPatient.medicalProfile.chronicConditions[0] || "General Wellness";

    let title = "General Preventive Wellness Plan";
    let goals = [
      "Maintain healthy weight (BMI 18.5 - 24.9)",
      "Keep daily steps above 8,000",
      "Consume 5+ servings of fruits/vegetables",
    ];
    let tasks: TreatmentTask[] = [
      {
        id: "task_1",
        task: "Perform 30 minutes of moderate aerobic exercise",
        frequency: "Daily",
        completed: false,
      },
      {
        id: "task_2",
        task: "Log daily nutritional intake",
        frequency: "Daily",
        completed: false,
      },
      {
        id: "task_3",
        task: "Log daily step count in wellness app",
        frequency: "Daily",
        completed: false,
      },
    ];
    ...
    if (condition.includes("Hypertension")) {
      ...
      tasks = [
        {
          id: "task_1",
          task: "Measure and record blood pressure (Morning)",
          frequency: "Twice daily",
          completed: false,
        },
        {
          id: "task_2",
          task: "Measure and record blood pressure (Evening)",
          frequency: "Twice daily",
          completed: false,
        },
        {
          id: "task_3",
          task: "Take Lisinopril 20mg in the morning",
          frequency: "Daily",
          completed: false,
        },
        {
          id: "task_4",
          task: "Follow low-sodium DASH diet guidelines",
      ...
      tasks = [
        {
          id: "task_1",
          task: "Check blood glucose level before breakfast",
          frequency: "Daily",
          completed: false,
        },
        {
          id: "task_2",
          task: "Take Metformin 1000mg with breakfast",
          frequency: "Twice daily",
          completed: false,
        },
        {
          id: "task_3",
          task: "Take Metformin 1000mg with dinner",
          frequency: "Twice daily",
          completed: false,
        },
        {
          id: "task_4",
          task: "Complete foot exam for microvascular checks",
          frequency: "Daily",
          completed: false,
        },
        {
          id: "task_5",
          task: "Aerobic exercise (brisk walking) for 30 minutes",
          frequency: "Daily",
          completed: false,
        },
      ];
      ...
      tasks = [
        {
          id: "task_1",
          task: "Take maintenance Fluticasone inhaler (2 puffs)",
          frequency: "Twice daily",
          completed: false,
        },
        {
          id: "task_2",
          task: "Measure peak flow rate in the morning",
          frequency: "Daily",
          completed: false,
        },
        {
          id: "task_3",
          task: "Keep rescue Albuterol inhaler in bag/close reach",
          frequency: "Constant",
          completed: false,
        },
      ];
  ...
  const progressPercentage = useMemo(() => {
    ...
    const completed = treatmentPlan.tasks.filter(
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Structured care strategies, wellness targets, and daily self-care
            checklists
          </p>
        </div>
        <CustomSelect
        ...
        <div className="space-y-5">
          <Card className="rounded-xl border border-slate-100 bg-white shadow-sm dark:border-slate-800 dark:bg-card">
            <CardHeader>
              ...
              <CardDescription>
                Clinical milestones set by provider
              </CardDescription>
            </CardHeader>
